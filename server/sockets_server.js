...
var roomStorage= require('./map_router_to_sockets.js');
var roomData= {};
module.exports.initSockets= function(socket, clients, ioAccess){
  ...
  socket.on('joinRoom', function(data){
    if (!roomData[data.room]){
      roomData[data.room] = Object.assign({}, roomStorage);
    }
    // console.log('line12', roomStorage.gameboard);
    socket.join(data.room);
    console.log('line 13', roomData[data.room].gameboard.clues);
    ioAccess.in(data.room).emit('hostJoins', roomStorage.gameboard);
